...
$toEmail = "christianvotion@gmail.com"; // Replace Your Email Address
...
$fromEmail = "cjvotion828@gmail.com.com";  // Replace Company's Email Address (preferably currently used Domain Name)
$fromName = "Votion Website"; // Replace Company Name
...
if (filter_var($toEmail, FILTER_VALIDATE_EMAIL)) {
	...
	echo json_encode(array('response' => 'error', 'Message' => '<div class="alert alert-danger alert-dismissible fade show text-start"><i class="fa fa-exclamation-triangle me-1"></i> There is an invalid <strong>Receivers Email</strong> address! <button type="button" class="btn-close text-1 mt-1" data-bs-dismiss="alert"></button></div>'));
	exit;
}
} else {
